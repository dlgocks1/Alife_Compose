...
import com.alife.vegan.ui.setting.SettingDietDirectionScreen
    ...
    BottomNavigation(
      ...
      bottomNavItems.forEach { screen ->
        BottomNavigationItem(
          icon = {
            Icon(
              painter = painterResource(id = screen.drawableResId ?: return@BottomNavigationItem),
...
fun NavGraphBuilder.settingGraph(navController: NavController) {
  navigation(startDestination = Screen.SettingGender.route, route = "SettingGraph") {
    ...
    composable(Screen.SettingDietDirection.route) { SettingDietDirectionScreen(navController) }
  }
}

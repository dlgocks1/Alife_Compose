...
@Composable
fun KcalProgressBar(targetvalue: Float) {
  ...
  Column {
    Box(
      ...
      Column(
        ...
        Text(text = "1250Kcal", fontSize = 23.sp, fontWeight = FontWeight.Bold)
        Text(text = "1250Kcal/day", fontSize = 12.sp, color = Color(0xFF474957))
      }
    }
  }
}